...
- [x] Fix `devkit sync` → write to `.specify/memory/constitution.md`
- [x] Add constitution transformer: invariants → spec-kit principles format
- [x] Rewrite SpecKit/SKILL.md with real `/speckit.*` command names and full workflow
- [x] Add clarify, analyze, checklist steps to SpecKit workflow
- [x] Update `devkit gate` L3→L4: check spec-kit installed + constitution format
- [x] Update `devkit init`: check spec-kit, prompt install if missing
- [x] Sync SKILL.md copies to cli/skills/ and .claude/commands/
- [x] Update research assumptions (constitution compatibility = invalidated → resolved)
- [x] Regenerate constitution in new format (`devkit generate-constitution && devkit sync`)
- [x] Run tests, validate, coverage
